Chinchin2::Application.configure do
  ...
  config.assets.precompile += %w( application-desktop.css application-mobile.css jquery-1.9.1.min.js jquery.mobile-1.3.1.min.js sidetap.js mobile.js )
end
